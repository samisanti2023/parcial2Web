...
export class AlterItems1778857039595 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "items" ADD "availableCopies" integer NOT NULL DEFAULT '1'`);
        ...
        await queryRunner.query(`ALTER TABLE "items" ADD CONSTRAINT "UQ_efb1aea2faf7d0c2f69bf125373" UNIQUE ("isbn")`);
